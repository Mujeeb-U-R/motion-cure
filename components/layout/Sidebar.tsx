    ...
    >
      ...
      <div className="mt-3 flex flex-col items-center gap-3">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          onMouseEnter={() => setHoveredItem("insta")}
          onMouseLeave={() => setHoveredItem(null)}
          aria-label="Instagram"
          className="group relative flex h-9 w-9 items-center justify-center rounded-full border border-zinc-200/80 bg-white/90 text-zinc-500 transition hover:border-pink-500 hover:text-pink-500"
        >
          <AnimatePresence>
            {hoveredItem === "insta" && (
              <motion.span
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          onMouseEnter={() => setHoveredItem("fb")}
          onMouseLeave={() => setHoveredItem(null)}
          aria-label="Facebook"
          className="group relative flex h-9 w-9 items-center justify-center rounded-full border border-zinc-200/80 bg-white/90 text-zinc-500 transition hover:border-blue-500 hover:text-blue-600"
        >
          <AnimatePresence>
            {hoveredItem === "fb" && (
              <motion.span
